...
$sql = "select t1.pluID, sum(t1.amount) as sales, sum(t1.Tax) as taxAmount, t2.name as itemName  from  transaction as t1,  PLU as t2 where t1.pluId=t2.id and (date BETWEEN \"$startDate\" AND \"$stopDate\") group  by t1.pluId";
