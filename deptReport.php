...
$sql = "select t1.pluID, sum(t1.amount) as sales, sum(t1.Tax) as taxAmount, t2.name as itemName  from  transaction as t1,  department as t2 where t1.deptId=t2.id  group  by t1.deptId";
